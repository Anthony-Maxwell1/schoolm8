...
export const themes: ThemeMap = {
    ...
    light: {
        ...
        flex flex-col overflow-hidden text-gray-900 p-6
        transition-all duration-300
      ...
      <div class="absolute -top-12 left-6 right-6 h-12 z-30 flex items-center justify-between px-4
        ...
        <div class="flex gap-2 items-center flex-shrink-0">
          <button class="w-8 h-8 rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-gray-600 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 16 16">
              <rect x="3" y="7" width="10" height="2" rx="1"/>
            </svg>
          </button>
          <button class="w-8 h-8 rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-gray-600 group-hover:text-gray-900" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 16 16">
              <rect x="4" y="4" width="8" height="8" rx="0.5"/>
            </svg>
          </button>
          <button class="w-8 h-8 rounded-lg hover:bg-red-50 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-gray-600 group-hover:text-red-600" fill="currentColor" viewBox="0 0 16 16">
              <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a .5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
            </svg>
          </button>
        </div>
    ...
    dark: {
      ...
      <div class="absolute -top-12 left-6 right-6 h-12 z-30 flex items-center justify-between px-4
        ...
        <div class="flex items-center gap-3 flex-1 min-w-0">
          ...
          <span class="text-sm font-normal text-slate-200 truncate tracking-tight">
            {__TILE_TITLE__}
          </span>
        </div>
        <div class="flex gap-2 items-center flex-shrink-0">
          <button class="w-8 h-8 rounded-lg hover:bg-slate-800 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-slate-400 group-hover:text-slate-200" fill="currentColor" viewBox="0 0 16 16">
              <rect x="3" y="7" width="10" height="2" rx="1"/>
            </svg>
          </button>
          <button class="w-8 h-8 rounded-lg hover:bg-slate-800 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-slate-400 group-hover:text-slate-200" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 16 16">
              <rect x="4" y="4" width="8" height="8" rx="0.5"/>
            </svg>
          </button>
          <button class="w-8 h-8 rounded-lg hover:bg-red-500/10 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-slate-400 group-hover:text-red-500" fill="currentColor" viewBox="0 0 16 16">
              <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
            </svg>
          </button>
        </div>
    ...
    community: {
        classes: {
            ...
            Tile: tw(`
        h-full w-full rounded-b-2xl
        bg-gradient-to-br from-purple-900/40 to-pink-900/40 backdrop-blur-2xl
        border border-purple-500/30
        shadow-[0_8px_32px_rgba(168,85,247,0.2)]
        flex flex-col overflow-hidden text-white p-6
        transition-all duration-300
        hover:from-purple-900/50
        hover:to-pink-900/50
        hover:border-purple-500/50
        hover:shadow-[0_12px_48px_rgba(168,85,247,0.3)]
      `),
        },
        TopBar: `
      <div class="absolute -top-12 left-6 right-6 h-12 z-30 flex items-center justify-between px-4
                  bg-gradient-to-r from-purple-900/40 to-pink-900/40 backdrop-blur-2xl
                  border border-purple-500/30
                  rounded-t-2xl
                  shadow-[0_4px_16px_rgba(168,85,247,0.2)]
                  transition-all duration-300
                  hover:from-purple-900/50
                  hover:to-pink-900/50">
        <div class="flex items-center gap-3 flex-1 min-w-0">
          ...
          <span class="text-sm font-normal text-purple-100 truncate tracking-tight">
            {__TILE_TITLE__}
          </span>
        </div>
        <div class="flex gap-2 items-center flex-shrink-0">
          <button class="w-8 h-8 rounded-lg hover:bg-purple-500/20 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-purple-300 group-hover:text-purple-100" fill="currentColor" viewBox="0 0 16 16">
              <rect x="3" y="7" width="10" height="2" rx="1"/>
            </svg>
          </button>
          <button class="w-8 h-8 rounded-lg hover:bg-purple-500/20 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-purple-300 group-hover:text-purple-100" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 16 16">
              <rect x="4" y="4" width="8" height="8" rx="0.5"/>
            </svg>
          </button>
          <button class="w-8 h-8 rounded-lg hover:bg-red-500/20 transition-colors flex items-center justify-center group">
            <svg class="w-3 h-3 text-purple-300 group-hover:text-red-400" fill="currentColor" viewBox="0 0 16 16">
              <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
            </svg>
          </button>
        </div>
