const BASE_DOMAIN = "*****"; // Base domain, no protocol or trailing slash
const USERNAME = "*********";
const PASSWORD = "*********";
...
async function fetchTimetable(authCookies) {
...
const authCookies = loginFlow().catch(console.error);

const timetable = authCookies.then(fetchTimetable).catch(console.error);
