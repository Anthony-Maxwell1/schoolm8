...
import * as __fd_glob_7 from "../content/docs/admins/index.mdx?collection=docs"
import * as __fd_glob_6 from "../content/docs/developers/index.mdx?collection=docs"
import * as __fd_glob_5 from "../content/docs/developers/customization.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "admins/meta.json": __fd_glob_1, "developers/meta.json": __fd_glob_2, "users/meta.json": __fd_glob_3, }, {"index.mdx": __fd_glob_4, "developers/customization.mdx": __fd_glob_5, "developers/index.mdx": __fd_glob_6, "admins/index.mdx": __fd_glob_7, "users/customization.mdx": __fd_glob_8, "users/faq.mdx": __fd_glob_9, "users/features.mdx": __fd_glob_10, "users/getting-started.mdx": __fd_glob_11, "users/index.mdx": __fd_glob_12, "users/premium.mdx": __fd_glob_13, "users/settings.mdx": __fd_glob_14, "users/troubleshooting.mdx": __fd_glob_15, });