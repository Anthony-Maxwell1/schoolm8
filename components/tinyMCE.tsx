...
export default function TextEditorClient() {
    ...
    const trafficColor =
        aiUsage === "full" ? "#16a34a" : aiUsage === "partial" ? "#f59e0b" : "#ef4444";
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
            ...
            >
                ...
                >
                    <div
                        style={{ width: 14, height: 14, borderRadius: 3, background: trafficColor }}
                    />
                    <div style={{ fontSize: 14, fontWeight: 600 }}>AI Usage</div>
                    <div style={{ color: "rgba(230,238,248,0.7)", fontSize: 13 }}>
                        {aiUsage === "full" ? "Full" : aiUsage === "partial" ? "Partial" : "None"}
                    </div>
                </div>
            ...
            {showChats && (
                <div
                    style={{
                        ...
                        background: "#071029",
                        color: "#e6eef8",
                        boxShadow: "-8px 0 20px rgba(2,6,23,0.6)",
                        padding: 16,
                        display: "flex",
                    ...
                    <div style={{ overflowY: "auto", flex: 1 }}>
                        {fakeChats.map((c) => (
                            ...
                            >
                                ...
                                <div style={{ fontSize: 13, color: "rgba(230,238,248,0.7)" }}>
                                    {c.preview}
                                </div>
                            </div>
                        ))}
                            ...
                            {fakeProjects.map((p) => (
                                ...
                                >
                                    <div>
                                        ...
                                        <div
                                            style={{ fontSize: 13, color: "rgba(230,238,248,0.7)" }}
                                        >
                                            ID: {p.id}
                                        </div>
                                    </div>
